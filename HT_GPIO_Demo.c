...
static void HT_GPIO_InitButton(void) { // configurar a entrada
...
static void HT_GPIO_InitLed(void) {
  ...
  GPIO_InitStruct.af = PAD_MuxAlt0; //configurar no padrao 
  GPIO_InitStruct.pad_id = LED_PAD_ID; // identificar ID e pinos
